...
public class Input implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void update() {
        scroll = 0; //prevents scroll value from staying the same after the wheel was scrolled
    ...
    // Checks if the key was pressed in the last frame and is not pressed in the current frame
    public boolean isKeyUp(int keyCode) {
        return !keys[keyCode] && keysLast[keyCode];
    }

    // Checks if the key was not pressed in the last frame and is pressed in the current frame
